...
import { JsonLd, faqSchema, productSchema, breadcrumbSchema } from "@/lib/metadata";
...
/**
 * /launch — the dedicated sales funnel for the Knowledge Suite.
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <JsonLd
        data={[
          ...
          breadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "The Knowledge Suite", path: "/launch" },
          ]),
        ]}
      />
      <FunnelHeader />
