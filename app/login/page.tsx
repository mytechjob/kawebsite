      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <Link href="/" className="inline-block mb-6">
            <img src="/logo-trans.webp" alt="Knowledge Agents" className="h-12 w-auto mx-auto" />
          </Link>
          <h1 className="text-2xl font-bold font-display">Welcome back</h1>
          <p className="text-sm text-muted-foreground mt-1">Sign in to your Knowledge Agents account</p>
        </div>
