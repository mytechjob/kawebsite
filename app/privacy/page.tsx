...
const sections = [
  ...
  { heading: "Security", body: ["We implement industry-standard security measures including encryption in transit (TLS) and at rest, access controls, and regular security assessments.", "Data is scoped per workspace, and role-based access controls are available on Standard and Unlimited plans.", "Enterprise plans include SSO integration, audit logging, and custom data residency options."] },
