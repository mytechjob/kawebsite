...
export default async function SolutionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <PageLayout>
      <JsonLd data={[breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Solutions", path: "/solutions/customer-support" }, { name: solution.name, path: `/solutions/${solution.slug}` }]), faqSchema(solution.faqs)]} />
