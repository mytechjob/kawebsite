    ...
    <PageLayout>
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="mt-12 p-5 rounded-xl border bg-muted/20 text-sm text-muted-foreground">
          This document is provided as a general template and does not constitute legal advice. Please
          have your own counsel review and adapt it to your jurisdiction and business before relying on it.
        </div>
      </div>
    </PageLayout>
  );
