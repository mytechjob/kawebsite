    ...
    <section className="relative pt-16 pb-24 md:pt-20 md:pb-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center z-10">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl font-display font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70"
        >
        ...
        >
          ...
          content in minutes. It answers customer questions 24/7 and takes real
          action — booking meetings, creating tickets, checking orders, and capturing leads. No code required.
        </motion.p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
              <div className="space-y-4 text-left">
                ...
                <div className="p-4 border rounded-lg bg-background shadow-sm hover:border-primary/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">Product_Manual_v2.pdf</div>
                      <div className="text-xs text-muted-foreground">1.2MB • Trained just now</div>
                    </div>
                  </div>
                </div>
                <div className="p-4 border rounded-lg bg-background shadow-sm hover:border-primary/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">yoursite.com/help</div>
                      <div className="text-xs text-muted-foreground">Crawled 38 pages</div>
                    </div>
                  </div>
                </div>
                <div className="p-4 border rounded-lg bg-background shadow-sm flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium">Action: Book a meeting</div>
                    <div className="text-xs text-muted-foreground">Connected to your calendar</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background border rounded-xl shadow-lg flex flex-col h-[360px]">
                <div className="p-4 border-b flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-sm">Support Agent</div>
                ...
                <div className="flex-1 p-4 space-y-4 overflow-y-auto bg-muted/5 text-sm text-left">
                  <div className="flex gap-3 flex-row-reverse">
                    ...
                    <div className="bg-primary text-primary-foreground p-3 rounded-l-xl rounded-br-xl">
                      Can someone walk me through setup this week?
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div className="bg-primary/10 p-3 rounded-r-xl rounded-bl-xl">
                      Absolutely! I have Thursday at 2:00 PM or Friday at 10:00 AM open. Which works?
                    </div>
                  </div>
                  <div className="flex gap-3 flex-row-reverse">
                    <div className="w-8 h-8 rounded-full bg-muted flex-shrink-0 flex items-center justify-center font-bold text-xs">U</div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="bg-green-500/10 text-foreground p-3 rounded-r-xl rounded-bl-xl border border-green-500/20">
                      <span className="flex items-center gap-1.5 font-medium text-green-600 mb-1">
                        <Sparkles className="w-3.5 h-3.5" /> Action completed
                      </span>
                ...
                <div className="p-3 border-t">
                  <div className="h-10 bg-muted/50 rounded-full w-full" />
                </div>
              </div>
            </div>
          </div>
