...
export default function AboutPage() {
  return (
    <PageLayout>
      ...
      <PageHero
        eyebrow="About us"
        title="We help every business answer and act, instantly"
        description="Knowledge Agents was founded on a simple belief: great customer experiences shouldn't require a huge team or a big budget — they should be one upload away."
      />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-3xl space-y-6 text-lg leading-relaxed text-foreground/80">
          <p>
            When we started {SITE.name} in {SITE.foundedYear}, AI chatbots were everywhere — and almost
            all of them were frustrating. They followed rigid scripts, misunderstood simple questions,
            and, worst of all, could only ever say things. They couldn't <em>do</em> anything.
          </p>
          <p>
            Meanwhile, every business we talked to had the same problem: their teams spent countless
            hours answering the same questions and handling the same routine requests, while customers
            waited. The knowledge to help already existed — in help centers, documents, and policies —
            it just wasn't accessible at the moment people needed it.
          </p>
          <p>
            So we built {SITE.name}: a platform where anyone can turn their content into an AI agent
            that not only answers accurately, but takes real action — booking, ticketing, looking up
            orders, capturing leads. No code, no data science, no months of setup. Just upload your
            knowledge, connect your tools, and go live in minutes.
          </p>
          <p>
            Today, Knowledge Agents power millions of helpful conversations every month for teams across
            support, e-commerce, healthcare, education, and more. And we're just getting started.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-display mt-2">What guides us</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v) => {
              const Icon = v.icon;
              return (
                <div key={v.title} className="p-6 bg-background rounded-xl border">
