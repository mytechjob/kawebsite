        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-display font-bold mb-8">
              ...
              <span className="text-gradient">Knowledge Agents</span>
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Automate repetitive knowledge work so teams can focus on
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Free your experts from manual review to innovate and solve
                  complex problems
                </p>
              </div>
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Drive measurable outcomes and ROI across your entire
                  organization
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.h1
                variants={fadeIn}
                className="text-5xl lg:text-6xl font-display font-bold leading-[1.1]"
              >
                AI-powered digital analysts for{" "}
                <span className="text-gradient">document-centric work</span>
              </motion.h1>
              ...
              >
                Knowledge Agents redefine Knowledge Management. Instead of just
                storing and searching information, they let you create decisions
                and actions across all knowledge sets. Automate expert review,
                standardize outcomes, and operate with evidence at scale.
              </motion.p>
              ...
              >
                {[
                  ...
                  <span
                    key={audience}
                    className="px-3 py-1.5 rounded-full bg-secondary/50 text-sm text-muted-foreground border border-border"
                  >
                    {audience}
                  </span>
                ))}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              Information is growing faster than teams can act on it
            </h2>
            <p className="text-lg text-muted-foreground">
              Most tools help you store or find knowledge. Knowledge Agents help
              you operate on knowledge—turning documents into decisions,
              actions, and evidence-backed outcomes.
            </p>
          </div>
      ...
      <section id="new-km" className="py-24 scroll-mt-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              From knowledge storage → to knowledge execution
            </h2>
            <p className="text-lg text-muted-foreground">
              Traditional KM helps teams capture and find information (wikis,
              search, portals). Knowledge Agents go further: they turn knowledge
              into operational decisions and actions—consistently, at scale, and
              with evidence.
            </p>
          </div>
          ...
          <div className="bg-primary rounded-2xl p-8 md:p-12 text-primary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Decisioning on your knowledge, not just searching it
            </h3>
            <p className="text-primary-foreground/80 mb-6 max-w-2xl mx-auto">
              Get in touch and we'll map your knowledge sets to workflows and
              decision rules.
            </p>
            <WaitlistDialog>
              <Button
                ...
                data-testid="button-learn-more-km"
              >
                Learn More
              </Button>
            </WaitlistDialog>
      ...
      <section id="product" className="py-24 bg-secondary/30 scroll-mt-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              One platform. Governed intelligence.
            </h2>
            <p className="text-lg text-muted-foreground">
              Knowledge Agents combine structured extraction, rules-based
              evaluation, and explainable outputs—so teams can operate with
      ...
      <section id="use-cases" className="py-24 scroll-mt-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Click a use case to see what the agent produces: structured
              outputs, pass/fail rules, and evidence-backed summaries.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">
                Invoice validation & exceptions
              </h3>
              <p className="text-muted-foreground mb-6">
                Extract invoice fields, reconcile against PO/policy rules, and
                flag exceptions with evidence before they hit close.
              </p>
              ...
              <div className="rounded-lg border border-border overflow-hidden">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border">
                      <tr>
                        ...
                        <td className="px-3 py-2">INV-2024-0847</td>
                        <td className="px-3 py-2 text-green-600">Pass</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-2">$12,450.00</td>
                        <td className="px-3 py-2 text-amber-600">Review</td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2">PO Match</td>
                        <td className="px-3 py-2">PO-2024-0312</td>
                        <td className="px-3 py-2 text-green-600">Pass</td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 px-4 py-2 border-t border-border flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-amber-700 dark:text-amber-400">
                    Status: Review Required — Amount exceeds threshold
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">
                Contract clause & policy checks
              </h3>
              <p className="text-muted-foreground mb-6">
                Standardize contract review by detecting required clauses and
                flagging deviations from playbooks and policies.
              </p>
              ...
              <div className="rounded-lg border border-border overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border">
                      <tr>
                        <td className="px-3 py-2">Termination</td>
                        <td className="px-3 py-2 text-green-600">Yes</td>
                        <td className="px-3 py-2 text-green-600">Low</td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2">Indemnity</td>
                        <td className="px-3 py-2 text-green-600">Yes</td>
                        <td className="px-3 py-2 text-amber-600">Medium</td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2">Liability Cap</td>
                        <td className="px-3 py-2 text-red-600">No</td>
                        <td className="px-3 py-2 text-red-600">High</td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2">Confidentiality</td>
                        <td className="px-3 py-2 text-green-600">Yes</td>
                        <td className="px-3 py-2 text-green-600">Low</td>
                      </tr>
                    </tbody>
                ...
                <div className="bg-red-50 dark:bg-red-950/30 px-4 py-2 border-t border-border flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-red-700 dark:text-red-400">
                    Status: Non-Standard Review — Missing liability cap clause
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">
                Diligence red flags & readiness scoring
              </h3>
              <p className="text-muted-foreground mb-6">
                Review large deal rooms quickly and surface what matters: risks,
                gaps, and a readiness score with evidence packs.
              </p>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">
                Auto-updating Knowledge Base (with decisioning + actioning)
              </h3>
              <p className="text-muted-foreground mb-6">
                Keep institutional knowledge continuously current by
                automatically ingesting new content, normalizing it, resolving
                duplicates, and publishing a "single source of truth" that teams
                can trust.
              </p>
              ...
              <div className="rounded-lg border border-border overflow-hidden">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border">
                      <tr>
                        ...
                        <td className="px-3 py-2">Troubleshooting v2.1</td>
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-2">New pricing notes</td>
                        <td className="px-3 py-2 text-green-600">
                          Distributed
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="px-3 py-2">Policy update</td>
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-2">Release notes v4.2</td>
                        <td className="px-3 py-2 text-green-600">
                          Distributed
                        </td>
                      </tr>
                ...
                <div className="bg-green-50 dark:bg-green-950/30 px-4 py-2 border-t border-border flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-green-700 dark:text-green-400">
                    Status: Auto-Distributed — 12 teams notified
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          <div className="mt-12 bg-secondary/50 rounded-2xl p-8 text-center border border-border">
            <h3 className="text-xl font-bold mb-3">
              Want a different use case?
            </h3>
            <p className="text-muted-foreground mb-6">
              Tell us your workflow in Early Access and we'll tailor a demo.
            </p>
            <WaitlistDialog>
              <Button size="lg" data-testid="button-join-use-case">
                Join
              </Button>
            </WaitlistDialog>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl font-semibold text-primary mb-2">
              Get Started in Minutes — Just Connect Your Data
            </p>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <motion.div
                ...
                className="p-8 rounded-2xl bg-card border border-border hover:border-accent/50 transition-colors shadow-sm"
              >
                <div className="font-mono text-sm font-bold text-accent mb-6">
                  {item.step}
                </div>
      ...
      <section id="faq" className="py-24 scroll-mt-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              If you want, we can tailor an Early Access demo to your exact
              workflow.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-primary rounded-3xl p-12 text-center text-primary-foreground relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                Ready to replace manual review with scalable decisions?
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-transparent border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10 h-12 px-8"
                  asChild
                >
