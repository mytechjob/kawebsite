...
import { SEO, faqSchema, howToSchema } from "@/lib/seo";
    ...
    <PageLayout>
      <SEO
        ...
        jsonLd={[
          faqSchema(HOME_FAQS),
          howToSchema({
            name: "How to build a Knowledge Agent",
            description:
              "Build an AI agent trained on your content that answers questions and takes action, in three no-code steps.",
      ...
      <Pricing />
      <FAQ
        subheading="Everything you need to know about building AI agents with Knowledge Agents."
      />
      <CTA />
    </PageLayout>
  );
