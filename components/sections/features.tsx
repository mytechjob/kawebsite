      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((feature) => {
            ...
            return (
              <div key={feature.title} className="p-6 bg-background rounded-xl border hover:border-primary/50 transition-all duration-300 shadow-sm hover:shadow-md group">
        ...
        {showCta && limit && (
          <div className="text-center mt-12">
            <Link href="/features"><Button variant="outline" size="lg">Explore all features <ArrowRight className="ml-2 w-4 h-4" /></Button></Link>
          </div>
        )}
      </div>
    </section>
